...
if CONFIG["dbtype"] in ("sqlite3", "sqlite"):
    CONFIG["valid"] = CONFIG.get("datadir") is not None
else:
    CONFIG["valid"] = finish_db_configuration() and bool(CONFIG.get("datadir"))
